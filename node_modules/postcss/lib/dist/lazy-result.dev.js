...
function () {
  ...
  _createClass(LazyResult, [{
      ...
      if (this.hasListener) {
        ...
        if (this.listeners.OnceExit) {
          if (root.type === 'document') {
            ...
            try {
              for (var _iterator2 = root.nodes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function visitSync(visitors, node) {
      ...
      try {
        for (var _iterator4 = visitors[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    value: function runAsync() {
      ...
      var i, plugin, promise, root, stack, _promise, node, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _loop, _iterator5, _step5;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 39:
                ...
                return regeneratorRuntime.async(function _loop$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      ...
                      case 9:
                        _context.next = 11;
                        return regeneratorRuntime.awrap(visitor(root, _this4.helpers));
              ...
              _iterator5 = this.listeners.OnceExit[Symbol.iterator]();
