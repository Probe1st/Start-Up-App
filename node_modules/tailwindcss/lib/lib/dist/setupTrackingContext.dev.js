...
function setupTrackingContext(configOrPath) {
  return function (_ref3) {
    var tailwindDirectives = _ref3.tailwindDirectives,
        registerDependency = _ref3.registerDependency;
    return function (root, result) {
      ...
      var _ref4 = (0, _setupContextUtils.getContext)(root, result, tailwindConfig, userConfigPath, tailwindConfigHash, contextDependencies),
          _ref5 = _slicedToArray(_ref4, 3),
          context = _ref5[0],
          mTimesToCommit = _ref5[2];
      ...
      if (tailwindDirectives.size > 0) {
        ...
        var _ref6 = (0, _content.resolvedChangedContent)(context, candidateFiles, fileModifiedMap),
            _ref7 = _slicedToArray(_ref6, 2),
            changedContent = _ref7[0],
            contentMTimesToCommit = _ref7[1];
