...
function extractCandidates(node) {
  ...
  if (node.type === "rule") {
    ...
    try {
      for (var _iterator2 = node.selectors[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        try {
          for (var _iterator3 = classCandidates[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var classCandidate = _step3.value;
    ...
    node.walkRules(function (rule) {
      ...
      try {
        for (var _iterator4 = rule.selectors.flatMap(function (selector) {
          ...
          var _classCandidate = _step4.value;
...
function buildPluginApi(tailwindConfig, context, _ref5) {
  ...
  var api = {
    ...
    addBase: function addBase(base) {
      ...
      try {
        for (var _iterator6 = withIdentifiers(base)[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
    ...
    */
    addDefaults: function addDefaults(group, declarations) {
      ...
      try {
        for (var _iterator7 = withIdentifiers(groups)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    addComponents: function addComponents(components, options) {
      ...
      try {
        for (var _iterator8 = withIdentifiers(components)[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
    ...
    addUtilities: function addUtilities(utilities, options) {
      ...
      try {
        for (var _iterator9 = withIdentifiers(utilities)[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
  ...
  root.walkAtRules("layer", function (layerRule) {
    ...
    if (layerRule.params === "base") {
      ...
      try {
        ...
        for (var _iterator12 = layerRule.nodes[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
          _loop5();
        }
      } catch (err) {
      ...
      try {
        ...
        for (var _iterator13 = layerRule.nodes[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
          _loop6();
        }
      } catch (err) {
...
function registerPlugins(plugins, context) {
  ...
  try {
    for (var _iterator14 = plugins[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
      ...
      if (Array.isArray(plugin)) {
        ...
        try {
          for (var _iterator27 = plugin[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
            var pluginItem = _step27.value;
  ...
  try {
    var _loop10 = function _loop10() {
      var _step15$value = _slicedToArray(_step15.value, 2),
          variantName = _step15$value[0],
          variantFunctions = _step15$value[1];
    ...
    for (var _iterator15 = variantMap.entries()[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
      _loop10();
    }
  } catch (err) {
  ...
  if (safelist.length > 0) {
    ...
    try {
      for (var _iterator16 = safelist[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
      ...
      (function () {
        ...
        try {
          var _loop7 = function _loop7() {
            ...
            try {
              for (var _iterator19 = utils[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                var _util2 = _step19.value;
                var _iteratorNormalCompletion20 = true;
                var _didIteratorError20 = false;
                var _iteratorError20 = undefined;

                try {
                  for (var _iterator20 = checks[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
                    var _step20$value = _step20.value,
                        pattern = _step20$value.pattern,
                        _step20$value$variant = _step20$value.variants,
                        variants = _step20$value$variant === void 0 ? [] : _step20$value$variant;
                    ...
                    try {
                      for (var _iterator21 = variants[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
          ...
          for (var _iterator17 = classList[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
            _loop7();
          }
        } catch (err) {
        ...
        try {
          for (var _iterator18 = patternMatchingCount.entries()[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
            var _step18$value = _slicedToArray(_step18.value, 2),
                regex = _step18$value[0],
                count = _step18$value[1];
  ...
  context.getClassOrder = function getClassOrder(classes) {
    ...
    var rules = (0, _generateRules.generateRules)(new Set(sorted), context);
    ...
    try {
      for (var _iterator22 = rules[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
        var _step22$value = _slicedToArray(_step22.value, 2),
            rule = _step22$value[1];
  ...
  context.getClassList = function getClassList() {
    ...
    try {
      for (var _iterator23 = classList[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
        var util = _step23.value;
  ...
  context.getVariants = function getVariants() {
    ...
    try {
            ...
            try {
              var _loop9 = function _loop9() {
                ...
                if (Array.isArray(ruleWithVariant)) {
                  ...
                  try {
                    for (var _iterator26 = ruleWithVariant[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
                      var variantFunction = _step26.value;
                      localFormatStrings = [];
                      variantFunction(api);
                      formatStrings.push(localFormatStrings);
                    }
              ...
              for (var _iterator25 = fns[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
                var _options_values;
      ...
      for (var _iterator24 = context.variantOptions.entries()[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
        var _options_values;
...
function _markInvalidUtilityNode(context, node) {
  ...
  try {
    for (var _iterator28 = context.ruleCache[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
  ...
  if (contextMap.has(sourcePath)) {
    ...
    if (contextSourcesMap.has(oldContext)) {
      ...
      if (contextSourcesMap.get(oldContext).size === 0) {
        ...
        try {
          for (var _iterator29 = configContextMap[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
            var _step29$value = _slicedToArray(_step29.value, 2),
                _tailwindConfigHash = _step29$value[0],
                _context2 = _step29$value[1];
        ...
        try {
          for (var _iterator30 = oldContext.disposables.splice(0)[Symbol.iterator](), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
            var disposable = _step30.value;
