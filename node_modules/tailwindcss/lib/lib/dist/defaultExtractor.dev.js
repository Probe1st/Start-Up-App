  ...
  return function (content) {
    ...
    try {
      for (var _iterator = patterns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        results = [].concat(_toConsumableArray(results), _toConsumableArray((_content_match = content.match(pattern)) !== null && _content_match !== void 0 ? _content_match : []));
      }
    } catch (err) {
...
function buildRegExps(context) {
  var separator, variantGroupingEnabled, prefix, utility, variantPatterns, _i, _variantPatterns, variantPattern;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          variantGroupingEnabled = (0, _featureFlags.flagEnabled)(context.tailwindConfig, "variantGrouping");
          ...
          _regex.pattern([/@\[[^\s"'`]+\](\/[^\s"'`]+)?/, separator]), _regex.pattern([/([^\s"'`\[\\]+-)?\[[^\s"'`]+\]/, separator]), _regex.pattern([/[^\s"'`\[\\]+/, separator])]), // With quotes allowed
