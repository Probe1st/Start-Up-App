  ...
  pseudoClassVariants: function pseudoClassVariants(_ref6) {
    ...
    var variants = {
      group: function group(_, _ref8) {
        ...
        return modifier ? [":merge(.group\\/".concat((0, _escapeClassName["default"])(modifier), ")"), " &"] : [":merge(.group)", " &"];
      },
      peer: function peer(_, _ref9) {
        var modifier = _ref9.modifier;
        return modifier ? [":merge(.peer\\/".concat((0, _escapeClassName["default"])(modifier), ")"), " ~ &"] : [":merge(.peer)", " ~ &"];
      }
    };
...
var _corePlugins = {
  ...
  animation: function animation(_ref42) {
    ...
    var prefixName = function prefixName(name) {
      return "".concat(config("prefix")).concat((0, _escapeClassName["default"])(name));
    };
