...
function () {
  ...
  function RootTransformer(sucraseContext, transforms, enableLegacyBabel5ModuleInterop, options) {
    ...
    if (transforms.includes("imports")) {
      ...
      this.transformers.push(new _CJSImportTransformer["default"](this, tokenProcessor, importProcessor, this.nameManager, this.helperManager, reactHotLoaderTransformer, enableLegacyBabel5ModuleInterop, Boolean(options.enableLegacyTypeScriptModuleInterop), transforms.includes("typescript"), Boolean(options.preserveDynamicImport)));
    } else {
      this.transformers.push(new _ESMImportTransformer["default"](tokenProcessor, this.nameManager, this.helperManager, reactHotLoaderTransformer, transforms.includes("typescript"), options));
    }
