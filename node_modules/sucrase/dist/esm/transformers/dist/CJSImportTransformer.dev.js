...
function (_Transformer) {
  ...
  function CJSImportTransformer(rootTransformer, tokens, importProcessor, nameManager, helperManager, reactHotLoaderTransformer, enableLegacyBabel5ModuleInterop, enableLegacyTypeScriptModuleInterop, isTypeScriptTransformEnabled, preserveDynamicImport) {
    var _this;
  ...
  _createClass(CJSImportTransformer, [{
    ...
    value: function processExportDefault() {
      ...
      } else if ((0, _shouldElideDefaultExport["default"])(this.isTypeScriptTransformEnabled, this.tokens, this.declarationInfo)) {
