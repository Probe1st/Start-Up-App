...
function (_Transformer) {
  ...
  function ESMImportTransformer(tokens, nameManager, helperManager, reactHotLoaderTransformer, isTypeScriptTransformEnabled, options) {
    var _this;
    ...
    ;
    _this.nonTypeIdentifiers = isTypeScriptTransformEnabled ? (0, _getNonTypeIdentifiers.getNonTypeIdentifiers)(tokens, options) : new Set();
  ...
  _createClass(ESMImportTransformer, [{
    ...
    value: function process() {
      ...
      if (this.tokens.matches2(_types.TokenType._export, _types.TokenType.name) && this.tokens.matchesContextualAtIndex(this.tokens.currentIndex() + 1, _keywords.ContextualKeyword._type)) {
        ...
        if (this.tokens.matchesContextual(_keywords.ContextualKeyword._from) && this.tokens.matches1AtIndex(this.tokens.currentIndex() + 1, _types.TokenType.string)) {
          this.tokens.removeToken();
          this.tokens.removeToken();
          (0, _removeMaybeImportAssertion.removeMaybeImportAssertion)(this.tokens);
        }
    ...
    value: function processExportDefault() {
      if ((0, _shouldElideDefaultExport["default"])(this.isTypeScriptTransformEnabled, this.tokens, this.declarationInfo)) {
