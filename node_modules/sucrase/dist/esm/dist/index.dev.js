...
function getSucraseContext(code, options) {
  ...
  if (options.transforms.includes("imports")) {
    importProcessor = new _CJSImportProcessor["default"](nameManager, tokenProcessor, enableLegacyTypeScriptModuleInterop, options, options.transforms.includes("typescript"), helperManager);
