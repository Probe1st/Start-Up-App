...
var _readWord = _interopRequireDefault(require("./readWord"));
...
var IdentifierRole;
exports.IdentifierRole = IdentifierRole;
...
function getTokenFromCode(code) {
  ...
  (0, _util.unexpected)("Unexpected character '".concat(String.fromCharCode(code), "'"), _base.state.pos);
}
