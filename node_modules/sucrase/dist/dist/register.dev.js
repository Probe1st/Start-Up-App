...
function addHook(extension, options, hookOptions) {
  return pirates.addHook(function (code, filePath) {
    var _index$transform$call = _index.transform.call(void 0, code, _objectSpread({}, options, {
      sourceMapOptions: {
        compiledFilename: filePath
      },
      filePath: filePath
    })),
        transformedCode = _index$transform$call.code,
        sourceMap = _index$transform$call.sourceMap;
