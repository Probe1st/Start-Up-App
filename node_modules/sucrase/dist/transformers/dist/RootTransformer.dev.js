...
function () {
  ...
  function RootTransformer(sucraseContext, transforms, enableLegacyBabel5ModuleInterop, options) {
    ...
    if (transforms.includes("imports")) {
      ...
      this.transformers.push(new (0, _CJSImportTransformer2["default"])(this, tokenProcessor, importProcessor, this.nameManager, this.helperManager, reactHotLoaderTransformer, enableLegacyBabel5ModuleInterop, Boolean(options.enableLegacyTypeScriptModuleInterop), transforms.includes("typescript"), Boolean(options.preserveDynamicImport)));
    } else {
