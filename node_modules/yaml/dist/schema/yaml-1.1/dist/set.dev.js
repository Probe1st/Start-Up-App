...
function (_YAMLMap$YAMLMap) {
  ...
  _createClass(YAMLSet, [{
    ...
    value: function add(key) {
      var pair;
      if (Node.isPair(key)) pair = key;else if (key && _typeof(key) === 'object' && 'key' in key && 'value' in key && key.value === null) pair = new Pair.Pair(key.key, null);else pair = new Pair.Pair(key, null);
